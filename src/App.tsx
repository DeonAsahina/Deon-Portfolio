            ...
            <div className="flex flex-col items-center pt-12 pb-8 px-6">
              ...
              <div className="mt-4 flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10">
                {status === 'idle' || status === 'offline' ? (
                  <motion.img
                    src={status === 'idle' 
                      ? "https://raw.githubusercontent.com/DeonAsahina/Deon-Portfolio/main/20260314_120224.png"
                      : "https://raw.githubusercontent.com/DeonAsahina/Deon-Portfolio/main/20260314_120817.png"
                    }
                    alt={`${status} Status`}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10 flex items-center gap-3">
                    <div className="relative w-9 h-9 flex-shrink-0">
                      ...
                      <img 
                        src="https://raw.githubusercontent.com/DeonAsahina/Deon-Portfolio/main/20260316_081249.png" 
                        alt="PixelLab" 
          ...
          >
            ...
            <div className="space-y-4">
              <SocialCard 
                icon={
                  <img 
                    src="https://raw.githubusercontent.com/DeonAsahina/Deon-Portfolio/main/20260316_082027.png" 
                    alt="Discord" 
              ...
              <SocialCard 
                icon={
                  <img 
                    src="https://raw.githubusercontent.com/DeonAsahina/Deon-Portfolio/main/20260316_082003.png" 
                    alt="Telegram" 
                    className="w-full h-full object-cover rounded-2xl"
                    referrerPolicy="no-referrer"
                  />
