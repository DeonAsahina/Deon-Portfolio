            ...
            <div className="flex flex-col items-center pt-12 pb-8 px-6">
              ...
              <div className="text-center space-y-1">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <img 
                    src="https://i.postimg.cc/XpxF7PCV/20260314-115506.png" 
                    alt="Verified" 
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10 flex items-center gap-3">
                    <div className="relative w-9 h-9 flex-shrink-0">
                      ...
                      <img 
                        src="https://i.postimg.cc/PNj2CBPz/20260316-081249.png" 
                        alt="PixelLab" 
          ...
          >
            ...
            <div className="space-y-4">
              <SocialCard 
                icon={
                  <img 
                    src="https://i.postimg.cc/Mff62vVw/20260316-082027.png" 
                    alt="Discord" 
              ...
              <SocialCard 
                icon={
                  <img 
                    src="https://i.postimg.cc/fkVT0gph/20260316-082003.png" 
                    alt="Telegram" 
                    className="w-full h-full object-cover rounded-2xl"
                    referrerPolicy="no-referrer"
                  />
