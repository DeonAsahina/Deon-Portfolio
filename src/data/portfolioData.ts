...
export const initialProjects: ProjectItem[] = [
  ...
  },
  {
    ...
    description: 'A modern Discord Indonesia banner with a bold red theme, Japanese-inspired cloud accents, and a clean, eye-catching branding style.',
    longDescription: 'Designed as a branding asset for the Discord Indonesia community, this banner focuses on creating a bold and memorable identity. The composition uses a high-contrast red-and-black palette, motion-inspired light streaks, and Japanese-style cloud illustrations to deliver a premium gaming atmosphere. The custom emblem and typography establish a recognizable visual identity while maintaining a clean layout that works well across websites, social media, and promotional materials.',
    image: 'https://i.ibb.co.com/BWDpJ5H/20260226-230048.jpg',
    tags: ['PixelLab', 'Graphic Design'],
    liveUrl: '#',
    githubUrl: 'https://github.com',
    featured: true,
  },
